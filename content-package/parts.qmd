---
lang: de
title: "ACP-Index: Abschnitte"
aliases: 
  - "/survey-content/parts.html"
---
...
* `bookletModules`, `instruments` und `units` auf der Seite [Instrumente](instruments.qmd),
* `baseScales`, `derivedScales` und `aggregatedScales` auf der Seite [Skalen](scales.qmd)
