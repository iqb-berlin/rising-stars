...
Der IQB-ContentHub ist eine Webanwendung. Es handelt sich also um Software, die auf einem Server installiert werden muss. Das folgende Bild stellt die Funktionen des IQB-ContentHub im Zusammenklang mit den anderen Webanwendungen des IQB-Stack dar. Es handelt sich um eine Zielvorstellung[^1]:

![Zusammenwirken von ContentHub mit anderen TBA-Anwendungen](../assets/content-hub1.png){width="600" group="content-hub"}
...
![Funktionsbereiche des ContentHub](../assets/content-hub2.png){width="600" group="content-hub"}
