...
Sämtliche Daten stellt das IQB im StarS-Projekt über das **Survey Content Package** bereit[^1]. Diese Datenstruktur ist [hier erläutert](survey-content/index.qmd).
...
[^1]: Der Begriff "Survey" wird in dieser Dokumentation übergreifend verwendet. Im aktuellen Review-Prozess zeichnet sich ab, dass der Begriff "Assessment" besser geeignet ist. Eine Umbenennung in "Assessment Content Package" ist wahrscheinlich.