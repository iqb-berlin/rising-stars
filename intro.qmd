...
Rechts in der Darstellung ist mit "Assessment Content Package" der **Testcontent** für den Test dargestellt:
...
Sämtliche Daten stellt das IQB im StarS-Projekt über das **Assessment Content Package** bereit. Diese Datenstruktur ist [hier erläutert](content-package/index.qmd).
...
Im Projekt StarS stellt das IQB die Komponenten IQB-ResponseAnalyser, IQB-ContentPool und IQB-Testcenter bereit. Alle Datenformate des Assessment Content Package sind in diesen Webanwendungen bzw. -services implementiert.
